...
using System.Text;
using Accela.WindowsStoreSDK.Reflection;
...
namespace Accela.WindowsStoreSDK
{
        ...
        public static IJsonSerializerStrategy CurrentJsonSerializerStrategy
        {
            get
            {
                return _currentJsonSerializerStrategy ??
                    (_currentJsonSerializerStrategy = DataContractJsonSerializerStrategy);
            }
            set
            {
    ...
    internal class PocoJsonSerializerStrategy : IJsonSerializerStrategy
    {
        ...
        private object SerializeEnum(Enum p)
        {
            return Convert.ToDouble(p, CultureInfo.InvariantCulture);
        }

        private bool TrySerializeKnownTypes(object input, out object output)
        {
        ...
        private bool TrySerializeUnknownTypes(object input, out object output)
        {
            output = null;
